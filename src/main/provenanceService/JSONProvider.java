...
public final class JSONProvider {
	/**
	 * Private contsructor - JSONProvider is a utility class.
	 */
	 ...
	 */
	public static Node getNode(final Graph g,final  JSONObject j) {
		Node node = null;
		if (g != null)
	 ...
	 */
	public static Edge getEdge(final Graph g, final JSONObject edge) {
	 ...
	 * @throws QueryEvaluationException
	 */
	public static Graph getGraph(final  JSONArray graph) {
	 ...
	 */
	public static JSONObject getNodeJSON(final Node n) {
	 ...
	 */
	public static JSONObject getEdgeJSON(final Edge e) {
	 ...
	 */
	public static JSONArray getGraphJSON(final Graph g) {
		if (g == null)
			return null;
